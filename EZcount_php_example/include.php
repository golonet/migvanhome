...
//SESSION is needed!! if not called
//session_start();

function sendJsonRequest($url, $data = array()) {
	$options = array(
		'http' => array(
			'method' => 'POST',
...
define('API_KEY', 'b660f25280d9cd442dc1a5ab56b3cde49485dea7a4d8756caa160d7728201c14'); //AVI API
//define('API_KEY', 'f1c85d16fc1acd369a93f0489f4615d93371632d97a9b0a197de6d4dc0da51bf');
